...
Then I ran `sudo systemctl restart wpa_supplicant`, but got the same error. And of course I did, becacause the `wpa_supplicant` unit configures it to be managed by NetworkManager.

So, back to the drawing-board:

    # Disable the DBus-managed version, as I don't have NetworkManager installed.
    sudo systemctl disable --now wpa_supplicant
    # Enable the manual version.
...
I installed `rxvt`, gave it a sensible configuration, and ran:
