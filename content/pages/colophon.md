...
Modified: 2026-01-19 19:43
Status: hidden

This site was built with the [Pelican](https://getpelican.com/) static site builder.

It uses the [day.js](https://day.js.org/) library for rendering human-friendly times.
...
The theme is called _Air and Fire_, and is my own work, but I used [pelican-svbtle](https://github.com/wting/pelican-svbtle), which was the theme I originally used on the site, to help figure out the structure. It's not currently in a state where somebody else could use it, unfortunately.
